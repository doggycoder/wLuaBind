...
print("lua field dataFloat : " , tp.dataFloat)
print("lua field dataDouble : " , tp.dataDouble)
print("lua field name : " , tp.name)
print("lua field dataNumArray : " , tp:dataNumArray(3))
